...
export class WelcomePage extends PageViewElement {
    ...
    protected render() {
        return html`
        <h1>Scout Badge Requirements v0.1.08</h1>
        ...
        <h1>Releases</h1>
        <ul>
        <li>0.1.08 - Correct additional lint errors and warnings</li>
        <li>0.1.07 - Correct some lint errors and refresh</li>
        <li>0.1.06 - Improve layout for all badges page.</li>
        <li>0.1.05 - Menu only auto dismisses on small screens.</li>
