...
export class SectionBadges extends PageViewElement {
    ...
    protected render() {
        return html`
        <div class="tabs">
            <dile-tabs id="tabs" attrForSelected="name" selected="${this.badgeSet}">
                <dile-tab name="lawAndPromise"><a class='link' href="${this.section}/lawAndPromise/">Promise, Law and Motto</a></dile-tab>
                <dile-tab name="core"><a class='link' href="${this.section}/core/">Core badges</a></dile-tab>
                <dile-tab name="challenge"><a class='link' href="${this.section}/challenge/">Challenge awards</a></dile-tab>
                <dile-tab name="activity"><a class='link' href="${this.section}/activity/">Activity badges</a></dile-tab>
                <dile-tab name="staged"><a class='link' href="${this.section}/staged/">Staged badges</a></dile-tab>
            </dile-tabs>
